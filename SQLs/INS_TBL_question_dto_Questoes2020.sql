...
(2020,  1   ,'Disponível em: https://sites.psu.edu. Acesso em: 12 jun. 2018. Os recursos usados nesse pôster de divulgação de uma campanha levam o leitor a refletir sobre a necessidade de  
...
E -  censurar a mulher pelo uso de determinadas palavras.',1,1),
(2020,  2   ,'Disponível em: www.csuchico.edu. Acesso em: 11 dez. 2017. Nesse pôster de divulgação de uma campanha que aborda a diversidade e a inclusão, a interação dos elementos verbais e não verbais faz referência ao ato de  
...
E -  desvalorizar costumes de algumas sociedades.',1,1),
(2020,  3   ,'A Mother in a Refugee Camp No Madonna and Child could touch Her tenderness for a son She soon would have to forget... The air was heavy with odors of diarrhea, Of unwashed children with washed-out ribs And dried-up bottoms waddling in labored steps Behind blown-empty bellies. Other mothers there Had long ceased to care, but not this one: She held a ghost-smile between her teeth, and in her eyes the memory Of a mother’s pride... She had bathed him And rubbed him down with bare palms. She took from their bundle of possessions  A broken comb and combed The rust-colored hair left on his skull And then — humming in her eyes — began carefully  [to part it. In their former life this was perhaps  A little daily act of no consequence Before his breakfast and school; now she did it Like putting flowers on a tiny grave. ACHEBE, C. Collected Poems. New York: Anchor Books, 2004. O escritor nigeriano Chinua Achebe traz uma reflexão sobre a situação dos refugiados em um cenário pós-guerra civil em seu país. Essa reflexão é construída no poema por meio da representação de uma mãe, explorando a(s)  
...
E -  evidenciam uma mudança de comportamento.',1,1),
(2020,  1   ,'Pablo Pueblo Regresa un hombre en silencio De su trabajo cansado Su paso no lleva prisa Su sombra nunca lo alcanza Lo espera el barrio de siempre Con el farol en la esquina Con la basura allá en frente Y el ruido de la cantina Pablo Pueblo llega hasta el zaguán oscuro Y vuelve a ver las paredes Con las viejas papeletas Que prometían futuros en lides politiqueras Y en su cara se dibuja la decepción de la espera. BLADES, R. Disponível em: http://rubenblades.com. Acesso em: 26 jun. 2012 (fragmento). Rubén Blades é um compositor panamenho de canções socialmente engajadas. O título Pablo Pueblo, associado ao conteúdo da letra da canção, revela uma crítica social ao  
...
E -  apelativa, porque o poeta tenta convencer os leitores sobre sua dificuldade de compor um poema.',0,1),
(2020,  7   ,'Disponível em: www.globofilmes.globo.com. Acesso em: 13 dez. 2017 (adaptado).  A frase, título do filme, reproduz uma variedade linguística recorrente na fala de muitos brasileiros. Essa estrutura caracteriza-se pelo(a)  
...
E -  proporcionar performances estéticas de pessoas surdas.',0,1),
...
E -  interesse em produtos indesejáveis que revela uma consciência sustentável no mercado.',0,1),
...
E -  apelo pela identificação com a empresa extensiva ao amor patriótico.',0,1),
...
E -  reproduz a noção de que a melhoria da aptidão física pela prática de exercícios promove a saúde.',0,1),
(2020,  18  ,'Retrato de homem  A paisagem estrita ao apuro do muro feito vértebra a vértebra e escuro.  A geração dos pelos sobre a casca e os rostos em seus diques de sombra repostos. Os poços com seu lodo de ira e de tensão: entre cimento e fronte — um vão. As setas se atiram às margens de ninguém, ilesas a si mesmas retêm. Compassos de evasão entre falange e rua sondando a solitude nua. E na armadura de coisa salobra, um só segredo: a polpa toda é fruição de medo. ARAÚJO, L. C. Cantochão. Belo Horizonte: Imprensa Publicações — Governo do Estado de Minas Gerais, 1967. No poema, a descrição lírica do objeto representado é orientada por um olhar que  
...
E -  privilegia imagens relacionadas à exposição do dinamismo urbano.',0,1),
(2020,  19  ,'Senhor Juiz O instrumento do “crime” que se arrola Nesse processo de contravenção Não é faca, revólver ou pistola, Simplesmente, doutor, é um violão. Será crime, afinal, será pecado, Será delito de tão vis horrores, Perambular na rua um desgraçado Derramando nas praças suas dores? Mande, pois, libertá-lo da agonia (a consciência assim nos insinua) Não sufoque o cantar que vem da rua, Que vem da noite para saudar o dia. É o apelo que aqui lhe dirigimos, Na certeza do seu acolhimento Juntada desta aos autos nós pedimos E pedimos, enfim, deferimento. Disponível em: www.migalhas.com.br. Acesso em: 23 set. 2020 (adaptado). Essa petição de habeas corpus, ao transgredir o rigor da linguagem jurídica,  
...
E -  preços acessíveis de seus treinamentos.',0,1),
(2020,  21  ,'Sou o coração do folclore nordestino Eu sou Mateus e Bastião do Boi-bumbá Sou o boneco de Mestre Vitalino Dançando uma ciranda em Itamaracá Eu sou um verso de Carlos Pena Filho Num frevo de Capiba Ao som da Orquestra Armorial Sou Capibaribe Num livro de João Cabral Sou mamulengo de São Bento do Una Vindo no baque solto de maracatu Eu sou um auto de Ariano Suassuna No meio da Feira de Caruaru Sou Frei Caneca do Pastoril do Faceta Levando a flor da lira Pra Nova Jerusalém Sou Luiz Gonzaga E sou do mangue também Eu sou mameluco, sou de Casa Forte Sou de Pernambuco, sou o Leão do Norte LENINE; PINHEIRO, P.C. Leão do Norte. In: LENINE; SUZANO, M. Olho de peixe. São Paulo: Velas, 1993 (fragmento). O fragmento faz parte da canção brasileira contemporânea e celebra a cultura popular nordestina. Nele, o artista exalta as diferentes manifestações culturais pela  
...
E -  apresentação do Pastoril do Faceta, do maracatu, do bumba meu boi e dos autos como representação da musicalidade e do teatro popular religioso, bastante comum ao folclore brasileiro.',0,1),
(2020,  22  ,'Disponível em: www.facebook.com/ministeriodoesporte. Acesso em: 7 dez. 2017. Esse anúncio publicitário propõe soluções para um problema social recorrente, ao  
...
E -  redesenha a verdade, aproximando-se das definições lexicais.',0,1),
(2020,  26  ,'Disponível em: www.iotforall.com. Acesso em: 22 jun. 2018.  A realidade virtual é uma tecnologia de informação que, conforme sugere a imagem, tem como uma de suas principais funções  
...
E -  narrativo e injuntivo, pois o enunciador ensina o interlocutor como andar pelas ruas da cidade contando sobre sua própria experiência.',0,1),
(2020,  28  ,'Leandro Aparecido Ferreira, o MC Fioti, compôs em 2017 a música Bum bum tam tam, que gerou, em nove meses, 480 milhões de visualizações no YouTube. É o funk brasileiro mais ouvido na história do site.  A partir de uma gravação da flauta que achou na internet, MC Fioti fez tudo sozinho: compôs, cantou e produziu em uma noite só. “Comecei a pesquisar alguns tipos de flauta, coisas antigas. E nisso eu achei a ‘flautinha do Sebastian Bach’”, conta. A descoberta foi por acaso: Fioti não sabia quem era o músico alemão e não sabe tocar o instrumento.  A “flauta envolvente” da música é um trecho da Partita em Lá menor, escrita pelo alemão Johann Sebastian Bach por volta de 1723. Disponível em: https://g1.globo.com. Acesso em: 6 jun. 2018 (adaptado).  A incorporação de um trecho da obra para flauta solo de Johann Sebastian Bach na música de MC Fioti demonstra a  
...
E -  questionar os lugares predeterminados da família.',0,1),
(2020,  30  ,'Disponível em: www.bhaz.com.br. Acesso em: 14 jun. 2018. Essa campanha de conscientização sobre o assédio sofrido pelas mulheres nas ruas constrói-se pela combinação da linguagem verbal e não verbal. A imagem da mulher com o nariz e a boca cobertos por um lenço é a representação não verbal do(a)  
...
E -  reforçarem estereótipos de gênero masculino ou feminino nos esportes.',0,1),
(2020,  36  ,'LUTA: prática corporal imprevisível, caracterizada por determinado estado de contato proposital, que possibilita a duas ou mais pessoas se enfrentarem numa constante troca de ações ofensivas e/ou defensivas, regida por regras, com o objetivo mútuo sobre um alvo móvel personifi cado no oponente. GOMES, M. S. P. et al. Ensino das lutas: dos princípios condicionais aos grupos situacionais. Movimento, n. 2, abr.-jun. 2010 (adaptado). De acordo com o texto, podemos identifi car uma abordagem das lutas nas aulas de educação física quando o professor realiza uma proposta envolvendo  

A -  contato corporal intenso entre o aluno e seu oponente.  
B -  contenda entre os alunos que se agridem fi sicamente.  
C -  confronto corporal em que os vencedores são previamente identifi cados.  
D -  combate corporal intencional com ações regulamentadas entre os oponentes. 
E -  confl ito resolvido pelos alunos por meio de regras previamente estabelecidas.',0,1),
(2020,  37  ,'O conceito de saúde formulado na histórica VIII Conferência Nacional de Saúde, no ano de 1986, fi cou conhecido como um “conceito ampliado” de saúde, conforme ilustrado na fi gura. Esse conceito foi fruto de intensa mobilização em diversos países da América Latina nas décadas de 1970 e 1980, como resposta à crise dos sistemas públicos de saúde. BATISTELLA, C. Abordagens contemporâneas do conceito de saúde. Disponível em: www.dihs.ensp.fi ocruz.br. Acesso em: 23 set. 2020. Com base no conceito apresentado no texto, a saúde é consequência direta do(a)  
...
D -  preconceito. 
E -  educação.',0,1),
(2020,  44  ,'Disponível em: www.acontecendoaqui.com.br. Acesso em: 15 jun. 2018. Nessa campanha publicitária, a imagem da família e o texto verbal unem-se para reforçar a ideia de que  
...
E -  distanciado dos elementos narrados, que recorre ao ponto de vista do viajante como expressão de estranhamento.',0,1),
(2020,  46  ,'Embora inegáveis os benefícios que ambas as economias têm auferido do intercâmbio comercial, o Brasil tem reiterado seu objetivo de desenvolver com a China uma relação comercial menos assimétrica. Os números revelam com clareza a assimetria. As exportações brasileiras de produtos básicos, especialmente soja, minério de ferro e petróleo, compõem, dependendo do ano, algo entre 75% e 80% da pauta, ao passo que as importações brasileiras consistem, aproximadamente, em 95% de produtos industrializados chineses, que vão desde os mais variados bens de consumo até máquinas e equipamentos de alto valor. LEÃO, V. C. Prefácio. In: CINTRA, M. A. M.; SILVA FILHO, E. B.; PINTO, E. C. (Org.). China em transformação: dimensões econômicas e geopolíticas do desenvolvimento. Rio de Janeiro: Ipea, 2015. Uma ação estatal de longo prazo capaz de reduzir a assimetria na balança comercial brasileira, conforme exposto no texto, é o(a)  
...
E -  desregulamentação das propriedades nas zonas de fronteira.',0,1),
(2020,  48  ,'Nas últimas décadas, uma acentuada feminização no mundo do trabalho vem ocorrendo. Se a participação masculina pouco cresceu no período pós-1970, a intensificação da inserção das mulheres foi o traço marcante. Entretanto, essa presença feminina se dá mais no espaço dos empregos precários, onde a exploração, em grande medida, se encontra mais acentuada. NOGUEIRA, C. M. As trabalhadoras do telemarketing: uma nova divisão sexual do trabalho? In: ANTUNES, R. et al. Infoproletários: degradação real do trabalho virtual. São Paulo: Boitempo, 2009.  A transformação descrita no texto tem sido insuficiente para o estabelecimento de uma condição de igualdade de oportunidade em virtude da(s)  
...
E -  inibição de consórcios intermunicipais.',0,1),
(2020,  51  ,'Zona de pastoreio e cultura do algodão e cereais do agreste (1963) ANDRADE, M. C. A terra e o homem no Nordeste. São Paulo: Brasiliense, 1963.  A dinâmica produtiva apresentada na imagem tem como estratégia central a  
...
E -  intensificação da atividade pecuária.',0,1),
(2020,  52  ,'Dois grandes eventos históricos tornaram possível um caso como o de Menocchio: a invenção da imprensa e a Reforma. A imprensa lhe permitiu confrontar os livros com a tradição oral em que havia crescido e lhe forneceu as palavras para organizar o amontoado de ideias e fantasias que nele conviviam. A Reforma lhe deu audácia para comunicar o que pensava ao padre do vilarejo, conterrâneos, inquisidores — mesmo não tendo conseguido dizer tudo diante do papa, dos cardeais e dos príncipes, como queria. GINZBURG, C. O queijo e os vermes: o cotidiano e as ideias de um moleiro perseguido pela Inquisição. São Paulo: Cia. das Letras, 2006. Os acontecimentos históricos citados ajudaram esse indivíduo, no século XVI, a repensar a visão católica do mundo ao possibilitarem a  
...
E -  correção doutrinária das heresias medievais.',0,1),
(2020,  53  ,'“Devo estar chegando perto do centro da Terra. Deixe ver: deve ter sido mais de seis mil quilômetros, por aí...” (como se vê, Alice tinha aprendido uma porção de coisas desse tipo na escola, e embora essa não fosse uma oportunidade lá muito boa de demonstrar conhecimentos, já que não havia ninguém por perto para escutá-la, em todo caso era bom praticar um pouco) “... sim, deve ser mais ou menos essa a distância... mas então qual seria a latitude ou longitude em que estou?” (Alice não tinha a menor ideia do que fosse latitude ou longitude, mas achou que eram palavras muito imponentes). CARROLL, L. Aventuras de Alice: no País das Maravilhas, Através do espelho e outros textos. São Paulo: Summus, 1980. O texto descreve uma confusão da personagem em relação  
...
E -  rejeição de práticas exógenas.',0,1),
...
E -  velocidade das máquinas colheitadeiras.',0,1),
(2020,  57  ,'No caso do Departamento de Defesa dos Estados Unidos, a ênfase está posta no traçado de uma estratégia geral de desarticulação, não só dos inimigos reais como dos potenciais, inserida na concepção preventiva que supõe que a mínima dissidência é um sinal de perigo e de guerra futura. Deve-se ter capacidade para responder a uma guerra convencional tanto quanto para enfrentar um inimigo difuso, atentando simultaneamente para todas as áreas geográficas do planeta. Trata-se, sem dúvida, da estratégia com pretensões mais abrangentes que se desenvolveu até agora. CECEÑA, A. E. Hegemonias e emancipações no século XXI. Buenos Aires: Clacso, 2005 (adaptado). Tomando o texto como parâmetro, qual tendência contemporânea impulsiona a formulação de estratégias mais abrangentes por parte do Estado americano?  
...
E -  Projeção da diplomacia mundial.',0,1),
(2020,  58  ,'O planejamento deixou de controlar o crescimento urbano e passou a encorajá-lo por todos os meios possíveis e imagináveis. Cidades, a nova mensagem soou em alto e bom som, eram máquinas de produzir riquezas; o primeiro e principal objetivo do planejamento devia ser o de azeitar a máquina. HALL, P. Cidades do amanhã: uma história intelectual do planejamento e do projeto urbanos no século XX. São Paulo: Perspectiva, 2016 (adaptado). O modelo de planejamento urbano problematizado no texto é marcado pelo(a)  
...
E -  visão do catolicismo, que, desde a Idade Média, defendia a dignidade do trabalho e do lucro.',0,1),
...
E -  Reforma das políticas macroeconômicas e dos mecanismos de controle inflacionário.',0,1),
(2020,  65  ,'O conjunto representado pelo agronegócio demanda condições específicas que passam a ser exigidas dos territórios. Como há uma elevação da formação de fluxos, materiais e imateriais, a crescente articulação com as escalas que vão do local ao global terminam por pressionar o Estado a agir visando uma instalação no território de fixos diversos, bem como de uma regulação específica. LIMA, R. C.; PENNA, N. A. A logística de transportes do agronegócio em Mato Grosso (Brasil). Confins, n. 26, fev. 2016. O mapa e o texto se complementam indicando que a expansão das rodovias se deu como resposta ao(à)  
...
E -  estagnação de lavouras policultoras.',0,1),
(2020,  66  ,'Um dos resquícios franceses na dança são os comandos proferidos pelo marcador da quadrilha. Seu papel é anunciar os próximos passos da coreografia. O abrasileiramento de termos franceses deu origem, por exemplo, ao saruê (soirée — reunião social noturna, ordem para todos se juntarem no centro do salão), anarriê (en arrière — para trás) e anavã (en avant — para frente). Disponível em: www.ebc.com.br. Acesso em: 6 jul. 2015.  A característica apresentada dessa manifestação popular resulta do seguinte processo socio-histórico:  
...
E -  Apropriação de práticas estrangeiras.',0,1),
(2020,  67  ,'Vale da Grande Fenda Vulcões Disponível em: https://noticias.uol.com.br. Acesso em: 13 jun. 2018 (adaptado). Os aspectos físicos apresentados originam-se da atuação da força natural de  
...
E -  metamorfi smo de bordas continentais.',0,1),
(2020,  68  ,' A reabilitação da biografi a histórica integrou as aquisições da história social e cultural, oferecendo aos diferentes atores históricos uma importância diferenciada, distinta, individual. Mas não se tratava mais de fazer, simplesmente, a história dos grandes nomes, em formato hagiográfi co — quase uma vida de santo —, sem problemas, nem máculas. Mas de examinar os atores (ou o ator) célebres ou não, como testemunhas, como refl exos, como reveladores de uma época. DEL PRIORE, M. Biografi a: quando o indivíduo encontra a história. Topoi, n. 19, jul.-dez. 2009. De acordo com o texto, novos estudos têm valorizado a história do indivíduo por se constituir como possibilidade de  
...
E -  interpretação das manifestações do divino.',0,1),
(2020,  69  ,' A sociedade como um sistema justo de cooperação social consiste em uma das ideias familiares fundamentais, que dá estrutura e organização à justiça como equidade. A cooperação social guia-se por regras e procedimentos publicamente reconhecidos e aceitos por aqueles que cooperam como sendo apropriados para regular a sua conduta. Diz-se que a cooperação é justa porque seus termos são tais que todos os participantes podem razoavelmente aceitar, desde que todos os demais também o aceitem. FERES JR., J.; POGREBINSCHI, T. Teoria política contemporânea: uma introdução. Rio de Janeiro: Elsevier, 2010. No contexto do pensamento político, a ideia apresentada mostra-se consoante o(a)  
...
E -  diálogo, que discute assuntos com diferentes interlocutores.',0,1),
...
E -  aprimoramento do conceito de fronteira.',0,1),
(2020,  76  ,' A principal característica da situação social dos anglo-americanos é seu caráter eminentemente democrático. Afirmei anteriormente que reinava uma igualdade muito grande entre os emigrantes que foram se estabelecer na Nova Inglaterra. Para isso contribuiu a influência das leis de sucessão. Estabelecidas de uma maneira, as leis de sucessão reúnem, concentram e agrupam em um só a propriedade e o poder. Estabelecidas por outros princípios, produzem o oposto: dividem, partilham e disseminam os bens e o poder. TOCQUEVILLE, A. A democracia na América. Belo Horizonte: Itatiaia; São Paulo: Edusp, 1977 (adaptado). O texto tematiza o papel desempenhado por uma norma na criação de um ambiente propício ao(à)  
...
E -  hierarquização dos agentes econômicos.',0,1),
(2020,  77  ,'Vemos que toda cidade é uma espécie de comunidade, e toda comunidade se forma com vistas a algum bem, pois todas as ações de todos os homens são praticadas com vistas ao que lhe parece um bem; se todas as comunidades visam algum bem, é evidente que a mais importante de todas elas e que inclui todas as outras tem mais que todas este objetivo e visa ao mais importante de todos os bens. ARISTÓTELES. Política. Brasília: UnB,1988. No fragmento, Aristóteles promove uma reflexão que associa dois elementos essenciais à discussão sobre a vida em comunidade, a saber:  
...
E -  Geração e corrupção, pois abarcam o campo da physis.',0,1),
(2020,  78  ,'O toyotismo, a partir dos anos 1970, teve grande impacto no mundo ocidental, quando se mostrou para os países avançados como uma opção possível para a superação de uma crise de acumulação. ANTUNES, R. Os sentidos do trabalho: ensaio sobre a afirmação e a negação do trabalho. São Paulo: Boitempo, 2009 (adaptado).  A característica organizacional do modelo em questão, requerida no contexto de crise, foi o(a)  
...
E -  centralização das etapas de planejamento.',0,1),
(2020,  79  ,'O fenômeno histórico conhecido como “tráfico de coolies” esteve associado diretamente ao período que vai do final da década de 1840 até o ano de 1874, quando milhares de chineses foram encaminhados principalmente para Cuba e Peru e muitos abusos no recrutamento de mão de obra foram identificados. O tráfico de coolies ou, em outros termos, o transporte por meios coativos de mão de obra de um lugar para outro, foi comparado ao tráfico africano de escravos por muitos periodistas e analistas do século XIX. SANTOS, M. A. Migrações e trabalho sob contrato no século XIX. História, n. 12, 2017.  A comparação mencionada no texto foi possível em razão da seguinte característica:  
...
E -  Investimento requerido dos empregadores.',0,1),
(2020,  80  ,'Os seringueiros amazônicos eram invisíveis no cenário nacional nos anos 1970. Começaram a se articular como um movimento agrário no início dos anos 1980, e na década seguinte conseguiram reconhecimento nacional, obtendo a implantação das primeiras reservas extrativas após o assassinato de Chico Mendes. Assim, em vinte anos, os camponeses da floresta passaram da invisibilidade à posição de paradigma de desenvolvimento sustentável com participação popular. ALMEIDA, M. W. B. Direitos à floresta e ambientalismo: seringueiros e suas lutas. Revista Brasileira de Ciências Sociais, n. 55, 2004. De acordo com o texto, a visibilidade dos seringueiros amazônicos foi estabelecida pela relação entre  
...
E -  clima ameno.',0,1),
(2020,  83  ,'Ao abrigo do teto, sua jornada de fé começava na sala de jantar. Na pequena célula cristã, dividia-se a refeição e durante elas os crentes conversavam, rezavam e liam cartas de correligionários residentes em locais diferentes do Império Romano (século II da Era Cristã). Esse ambiente garantia peculiar apoio emocional às experiências intensamente individuais que abrigava. SENNET, R. Carne e pedra. Rio de Janeiro: Record, 2008. Um motivo que explica a ambientação da prática descrita no texto encontra-se no(a)  
...
E -  violência senhorial, que impunha a desestruturação forçada das famílias escravas.',0,1),
(2020,  84  ,' A colisão entre uma placa continental e uma oceânica provocará a subducção desta última sob a placa continental, que, a exemplo dos arcos e ilhas, produzirá um arco magmático na borda do continente, composto por rochas vulcânicas acompanhado de deformações e metamorfismo tanto de rochas preexistentes como de parte das rochas formadas no processo. TEIXEIRA, W. et al. (Org.). Decifrando a Terra. São Paulo: Oficina de Textos, 2000. Qual feição fisiográfica é gerada pelo processo tectônico apresentado?  
...
E -  elites locais acerca da ordenação do monopólio fundiário.',0,1),
(2020,  86  ,'Declaração de Direitos do Homem e do Cidadão – 1789 Os representantes do povo francês, tendo em vista que a ignorância, o esquecimento ou o desprezo dos direitos do homem são as únicas causas dos males públicos e da corrupção dos governos, resolveram declarar solenemente os direitos naturais, inalienáveis e sagrados do homem, a fim de que esta declaração, sempre presente em todos os membros do corpo social, lhes lembre permanentemente seus direitos e seus deveres; a fim de que as reivindicações dos cidadãos, fundadas em princípios simples e incontestáveis, se dirijam sempre à conservação da Constituição e à felicidade geral. Disponível em: www.direitoshumanosusp.br. Acesso em: 7 jun. 2018 (adaptado). Esse documento, elaborado no contexto da Revolução Francesa, reflete uma profunda mudança social ao estabelecer a  
...
E -  participação no exercício do poder.',0,1),
(2020,  88  ,'TEXTO I Rio Tietê, São Paulo (SP). Foto: Delfim Martins/Pulsar. TEXTO II O Rio Tietê está morto. Ao menos uma parte dele: 137 quilômetros, para ser mais preciso. Uma pesquisa da Fundação SOS Mata Atlântica mostra que, em 2016, o trecho do rio com qualidade de água classificada como ruim ou péssima começa em Itaquaquecetuba, passa por toda a Região Metropolitana de São Paulo e chega até Cabreúva, já no interior de São Paulo. Nesse trecho, a água não tem oxigênio suficiente para abrigar vida. Disponível em: http://epoca.globo.com. Acesso em: 7 dez. 2017 (adaptado). Considerando a análise dos textos, a condição atual desse rio tem como origem a  
...
E -  O desenvolvimento do raciocínio abstrato.',0,1),
(2020,  90  ,'TEXTO I O aumento de casos suspeitos de febre amarela em Minas pode estar relacionado à tragédia de Mariana, em 2015, segundo a bióloga da Fiocruz Márcia Chame.  A hipótese tem como ponto de partida a localização das cidades mineiras que identificaram até o momento casos de pacientes com sintomas da doença. Grande parte está na região próxima do Rio Doce, afetado pelo rompimento da Barragem de Fundão, em novembro de 2015. FORMENTI, L. Para bióloga, surto de febre amarela pode ter relação com tragédia de Mariana. O Estado de São Paulo, 14 jan. 2017. TEXTO II Por outro lado, Servio Ribeiro considera remota a possibilidade de influência da tragédia de Mariana (MG) neste surto de febre amarela em Minas Gerais. “A febre amarela é uma doença de interior de floresta. O mosquito que a transmite põe ovos em cavidades de árvores e em bromélias. É um mosquito da estrutura da floresta. Ele não se relaciona muito com grandes corpos-d’água e com rios. As cidades afetadas pela doença estão em uma região onde os rejeitos não chegaram com força para derrubar a floresta”, diz o biólogo. RODRIGUES, L. Especialistas investigam relação entre febre amarela e degradação ambiental. Agência Brasil, 25 jan. 2017. Sobre a tragédia de Mariana, os textos apresentam divergência quanto ao(à)  
...
E -  surgimento de comunidades desabrigadas.',0,1),
(2020,  91  ,'DAVIS, J. Disponível em: http://garfield.com. Acesso em: 10 fev. 2015. Por qual motivo ocorre a eletrização ilustrada na tirinha?  
...
E -  Repulsão entre partículas elétricas da calça e dos pelos do gato.',0,1),
...
E -  apresentam propriedades mecânicas semelhantes aos convencionais.',0,1),
...
D -  4 
E -  5',0,1),
(2020,  95  ,'A fragmentação dos hábitats é caracterizada pela formação de ilhas da paisagem original, circundadas por áreas transformadas. Esse tipo de interferência no ambiente ameaça a biodiversidade. Imagine que uma população de onças foi isolada em uma mata pequena. Elas se extinguiriam mesmo sem terem sido abatidas. Diversos componentes da ilha de hábitat, como o tamanho, a heterogeneidade, o seu entorno, a sua conectividade e o efeito de borda são determinantes para a persistência ou não das espécies originais. Uma medida que auxilia na conservação da biodiversidade nas ilhas mencionadas no texto compreende a  
...
E -  introdução de novas espécies de animais e vegetais.',0,1),
(2020,  96  ,'A sacarase (ou invertase) é uma enzima que atua no intestino humano hidrolisando o dissacarídeo sacarose nos monossacarídeos glicose e frutose. Em um estudo cinético da reação de hidrólise da sacarose (C12H22O11), foram dissolvidos 171 g de sacarose em 500 mL de água. Observou-se que, a cada 100 minutos de reação, a concentração de sacarose foi reduzida à metade, qualquer que fosse o momento escolhido como tempo inicial. As massas molares dos elementos H, C e O são iguais a 1, 12 e 16 g mol−1, respectivamente. Qual é a concentração de sacarose depois de 400 minutos do início da reação de hidrólise?  

A -  2,50 × 10−3 mol L−1  
B -  6,25 × 10−2 mol L−1  
C -  1,25 × 10−1 mol L−1  
D -  2,50 × 10−1 mol L−1 
E -  4,27 × 10−1 mol L−1',0,1),
(2020,  97  ,'Grandes reservatórios de óleo leve de melhor qualidade e que produz petróleo mais fino foram descobertos no litoral brasileiro numa camada denominada pré-sal, formada há 150 milhões de anos.  A utilização desse recurso energético acarreta para o ambiente um desequilíbrio no ciclo do  
...
E -  resistência interna do condutor que constitui as bobinas, por meio de um aumento na espessura dos terminais.',0,1),
(2020,  99  ,'Você foi contratado para sincronizar os quatro semáforos de uma avenida, indicados pelas letras O, A,  B e C, conforme a figura. O A B C Os semáforos estão separados por uma distância de 500 m. Segundo os dados estatísticos da companhia controladora de trânsito, um veículo, que está inicialmente parado no semáforo O, tipicamente parte com aceleração constante de 1 m s−2 até atingir a velocidade de 72 km h−1 e, a partir daí, prossegue com velocidade constante. Você deve ajustar os semáforos A, B e C de modo que eles mudem para a cor verde quando o veículo estiver a 100 m de cruzá-los, para que ele não tenha que reduzir a velocidade em nenhum momento. Considerando essas condições, aproximadamente quanto tempo depois da abertura do semáforo O os semáforos A, B e C devem abrir, respectivamente?  

A -  20 s, 45 s e 70 s.  
B -  25 s, 50 s e 75 s.  
C -  28 s, 42 s e 53 s.  
D -  30 s, 55 s e 80 s. 
E -  35 s, 60 s e 85 s.',0,1),
(2020,  100 ,'Nos dias atuais, o amplo uso de objetos de plástico gera bastante lixo, que muitas vezes é eliminado pela população por meio da queima. Esse procedimento é prejudicial ao meio ambiente por lançar substâncias poluentes. Para constatar esse problema, um estudante analisou a decomposição térmica do policloreto de vinila (PVC), um tipo de plástico, cuja estrutura é representada na figura. Policloreto de vinila (PVC) Para realizar esse experimento, o estudante colocou uma amostra de filme de PVC em um tubo de ensaio e o aqueceu, promovendo a decomposição térmica. Houve a liberação majoritária de um gás diatômico heteronuclear que foi recolhido em um recipiente acoplado ao tubo de ensaio. Esse gás, quando borbulhado em solução alcalina diluída contendo indicador ácido-base, alterou a cor da solução. Além disso, em contato com uma solução aquosa de carbonato de sódio (Na2 CO3 ), liberou gás carbônico. Qual foi o gás liberado majoritariamente na decomposição térmica desse tipo de plástico?  
...
D -  CO2 
E -  HCl',0,1),
(2020,  101 ,'Uma população (momento A) sofre isolamento em duas subpopulações (momento B) por um fator de isolamento (I). Passado um tempo, essas subpopulações apresentam características fenotípicas e genotípicas que as distinguem (momento C), representadas na figura pelas tonalidades de cor. O posterior desaparecimento do fator de isolamento I pode levar, no momento D, às situações D1 e D2.  A representação indica que, no momento D, na situação  
...
E -  D2 foram preservadas as mesmas características fenotípicas da população original A.',0,1),
(2020,  102 ,'A obtenção de óleos vegetais, de maneira geral, passa pelas etapas descritas no quadro. Etapa Subetapa O que ocorre Preparação da matéria-prima Seleção dos grãos Separação das sujidades mais grossas Descascamento Separação de polpa e casca Trituração Rompimento dos tecidos e das paredes das células Cozimento Aumento da permeabilidade das membranas celulares Extração do óleo bruto Prensagem Remoção parcial do óleo Extração Obtenção do óleo bruto com hexano Destilação Separação do óleo e do solvente Qual das subetapas do processo é realizada em função apenas da polaridade das substâncias?  
...
D -  40 
E -  20',0,1),
(2020,  107 ,'A Torre Eiff el, com seus 324 metros de altura, feita com treliças de ferro, pesava 7 300 toneladas quando terminou de ser construída em 1889. Um arquiteto resolve construir um protótipo dessa torre em escala 1:100, usando os mesmos materiais (cada dimensão linear em escala de 1:100 do monumento real). Considere que a torre real tenha uma massa Mtorre e exerça na fundação sobre a qual foi erguida uma pressão Ptorre. O modelo construído pelo arquiteto terá uma massa Mmodelo e exercerá uma pressão Pmodelo. Como a pressão exercida pela torre se compara com a pressão exercida pelo protótipo? Ou seja, qual é a razão entre as pressões (Ptorre)/(Pmodelo) ?  
...
D -  104 
E -  106',0,1),
(2020,  108 ,'Na indústria farmacêutica, é muito comum o emprego de substâncias de revestimento em medicamentos de uso oral, pois trazem uma série de benefícios como alteração de sabor em medicamentos que tenham gosto ruim, melhoria da assimilação do composto, entre outras ações. Alguns compostos poliméricos à base do polissacarídeo celulose são utilizados para garantir que o fármaco somente seja liberado quando em contato com soluções aquosas cujo pH se encontre próximo da faixa da neutralidade. BORTOLINI, K. et al. Análise de perfil de dissolução de cápsulas gastrorresistentes utilizando polímeros industriais com aplicação em farmácias magistrais. Revista da Unifebe, n. 12, 2013 (adaptado). Qual é a finalidade do uso desse revestimento à base de celulose?  
...
D -  Reflexão. 
E -  Difração.',0,1),
(2020,  112 ,'Para garantir que produtos eletrônicos estejam armazenados de forma adequada antes da venda, algumas empresas utilizam cartões indicadores de umidade nas embalagens desses produtos. Alguns desses cartões contêm um sal de cobalto que muda de cor em presença de água, de acordo com a equação química: ∆H < 0 (azul) (rosa) Como você procederia para reutilizar, num curto intervalo de tempo, um cartão que já estivesse com a coloração rosa?  
...
D -   
E -  ',0,1),
(2020,  114 ,'Dois engenheiros estão verificando se uma cavidade perfurada no solo está de acordo com o planejamento de uma obra, cuja profundidade requerida é de 30 m. O teste é feito por um dispositivo denominado oscilador de áudio de frequência variável, que permite relacionar a profundidade com os valores da frequência de duas ressonâncias consecutivas, assim como em um tubo sonoro fechado. A menor frequência de ressonância que o aparelho mediu foi 135 Hz. Considere que a velocidade do som dentro da cavidade perfurada é de 360 m s-1 . Se a profundidade estiver de acordo com o projeto, qual será o valor da próxima frequência de ressonância que será medida?  
...
E -  sistema nervoso ganglionar que promove a coordenação central do movimento corporal.',0,1),
(2020,  119 ,'Pesquisadores coletaram amostras de água de um rio em pontos diferentes, distantes alguns quilômetros um do outro. Ao longo do rio, há locais de águas limpas, como também locais que recebem descarga de esgoto de área urbana, e locais onde há decomposição ativa com ausência de peixes. Os pesquisadores analisaram dois parâmetros: oxigênio dissolvido (OD) e demanda bioquímica de oxigênio (DBO) em cada ponto de coleta de água, obtendo o gráfico:  O OD é proveniente da atmosfera e da fotossíntese que ocorre no curso-d’água e sua concentração é função das variáveis físicas, químicas e bioquímicas locais. A DBO é a quantidade de oxigênio consumido por microrganismos em condições aeróbicas para degradar uma determinada quantidade de matéria orgânica, durante um período de tempo, numa temperatura de incubação específica. Disponível em: www.programaaguaazul.rn.gov.br. Acesso em: 16 ago. 2014 (adaptado). Qual ponto de amostragem da água do rio está mais próximo ao local em que o rio recebe despejo de esgoto?  
...
D -  99. 
E -  120.',0,1),
(2020,  121 ,'Em uma aula sobre metabolismo energético, foi apresentado um experimento clássico realizado por Engelmann. Um recipiente contendo bactérias aeróbias e uma alga verde filamentosa foi submetido à iluminação de uma fonte de luz, representada pelo microespectro. Após a explicação, um aluno esquematizou na lousa o resultado do referido experimento. Bactérias aeróbias Filamento de alga verde Microespectro Vermelho Amarelo Verde Azul Anil Violeta Considerando a figura, a faixa do microespectro em que a alga possui maior taxa de realização fotossintética é a do:  
...
D -  Amarelo. 
E -  Vermelho.',0,1),
(2020,  122 ,'O exame parasitológico de fezes é utilizado para detectar ovos de parasitos. Um dos métodos utilizados, denominado de centrífugo-flutuação, considera a densidade dos ovos em relação a uma solução de densidade 1,15 g mL−1. Assim, ovos que flutuam na superfície dessa solução são detectados. Os dados de densidade dos ovos de alguns parasitos estão apresentados na tabela. ZERBINI, A. M. Identificação e análise de viabilidade de ovos de helmintos em um sistema de tratamento de esgotos domésticos constituídos de reatores anaeróbios e rampas de escoamento superficial. Belo Horizonte: Prosab, 2001 (adaptado). Considerando-se a densidade dos ovos e da solução, ovos de quais parasitos podem ser detectados por esse método?  
...
E -  A. lumbricoides, A. suum e T. saginata.',0,1),
(2020,  123 ,'Em seu laboratório, um técnico em química foi incumbido de tratar um resíduo, evitando seu descarte direto no meio ambiente. Ao encontrar o frasco, observou a seguinte informação: “Resíduo: mistura de acetato de etila e água”. Considere os dados do acetato de etila: • Baixa solubilidade em água; • Massa específica = 0,9 g cm−3; • Temperatura de fusão = −83 °C; • Pressão de vapor maior que a da água.  A fim de tratar o resíduo, recuperando o acetato de etila, o técnico deve  
...
E -  decantar a mistura separando os dois componentes em um funil adequado.',0,1),
(2020,  124 ,'Em 2011, uma falha no processo de perfuração realizado por uma empresa petrolífera ocasionou derramamento de petróleo na bacia hidrográfica de Campos, no Rio de Janeiro. Os impactos decorrentes desse derramamento ocorrem porque os componentes do petróleo 
...
E -  têm cadeia pequena e elevada volatilidade, contaminando a atmosfera local e regional em função dos ventos nas orlas marítimas.',0,1),
(2020,  125 ,'Uma população encontra-se em equilíbrio genético quanto ao sistema ABO, em que 25% dos indivíduos pertencem ao grupo O e 16%, ao grupo A homozigotos. Considerando que: p = frequência de IA; q = frequência de IB; e r = frequência de i, espera-se encontrar:  A porcentagem de doadores compatíveis para alguém do grupo B nessa população deve ser de 
...
E -  Decaimento radioativo do carbono, provocado por partículas beta.',0,1),
(2020,  127 ,'Plantas pioneiras são as que iniciam o processo natural de cicatrização de uma área desprovida de vegetação. Em geral, têm pequeno porte e crescem muito rápido, desenvolvem-se a pleno sol e são pouco exigentes quanto às condições do solo. Produzem grande quantidade de sementes e possuem ciclo de vida curto. BLUM, C. T. Lista preliminar de espécies vegetais pioneiras nativas do Paraná – versão 2008. Disponível em: www.chaua.org.br. Acesso em: 10 fev. 2015. Essas plantas são importantes em um projeto de restauração ambiental, pois promovem, no solo, 

A -  aumento da incidência de luz solar. 
B -  diminuição da absorção de água.  
C -   estabilização da umidade. 
D -  elevação de temperatura. 
E -  liberação de oxigênio.',0,1),
...
D -  0,6 °C 
E -  0,3 °C',0,1),
(2020,  129 ,'Em uma pesquisa estão sendo testados cinco quimioterápicos quanto à sua capacidade antitumoral. No entanto, para o tratamento de pacientes, sabe-se que é necessário verificar também o quanto cada composto agride células normais. Para o experimento, partiu-se de cultivos de células tumorais (colunas escuras na figura) e células normais (colunas claras) com o mesmo número de células iniciais. Dois grupos-controle não receberam quimioterápicos: controle de células tumorais (CT) e de células normais (CN). As colunas I, II, III, IV e V correspondem aos grupos tratados com os cinco compostos. O número de células viáveis após os tratamentos está representado pelas colunas. Número de células (milhão) Qual quimioterápico deve ser escolhido para tratamento desse tipo de tumor? 
...
E -  Deleções durante as primeiras mitoses zigóticas na planta descendente C. arabica.',0,1),
(2020,  136 ,' A fabricação da Bandeira Nacional deve obedecer ao descrito na Lei n. 5.700, de 1º de setembro de 1971, que trata dos Símbolos Nacionais. No artigo que se refere às dimensões da Bandeira, observa-se: “Para cálculos das dimensões, será tomada por base a largura, dividindo-a em 14 (quatorze) partes iguais, sendo que cada uma das partes será considerada uma medida ou módulo (M). Os demais requisitos dimensionais seguem o critério abaixo: I. Comprimento será de vinte módulos (20 M); II. A distância dos vértices do losango amarelo ao quadro externo será de um módulo e sete décimos (1,7 M); III. O raio do círculo azul no meio do losango amarelo será de três módulos e meio (3,5 M).” BRASIL. Lei n. 5.700, de 1º de setembro de 1971.Disponível em: www.planalto.gov.br. Acesso em: 15 set. 2015.  A figura indica as cores da bandeira do Brasil e localiza o quadro externo a que se refere a Lei n. 5.700. Comprimento do quadro externo Largura do quadro externo Um torcedor, preparando-se para a Copa do Mundo e dispondo de cortes de tecidos verde (180 cm x 150 cm) e amarelo (o quanto baste), deseja confeccionar a maior Bandeira Nacional possível a partir das medidas do tecido verde. Qual a medida, em centímetro, do lado do menor quadrado de tecido azul que deverá ser comprado para confecção do círculo da bandeira desejada? 
...
D -  42/26 
E -  42/16',0,1),
(2020,  138 ,' A caixa-d’água de um edifício terá a forma de um paralelepípedo retângulo reto com volume igual a 28 080 litros. Em uma maquete que representa o edifício, a caixa-d’água tem dimensões 2 cm × 3,51 cm × 4 cm. Dado: 1 dm³ = 1 L. A escala usada pelo arquiteto foi 
...
E -  6 caixas do tipo B.',0,1),
(2020,  141 ,'Um hotel de 3 andares está sendo construído. Cada andar terá 100 quartos. Os quartos serão numerados de 100 a 399 e cada um terá seu número afixado à porta. Cada número será composto por peças individuais, cada uma simbolizando um único algarismo. Qual a quantidade mínima de peças, simbolizando o algarismo 2, necessárias para identificar o número de todos os quartos? 
...
D -  120 
E -  60',0,1),
(2020,  142 ,'O Estatuto do Idoso, no Brasil, prevê certos direitos às pessoas com idade avançada, concedendo a estas, entre outros benefícios, a restituição de imposto de renda antes dos demais contribuintes. A tabela informa os nomes e as idades de 12 idosos que aguardam suas restituições de imposto de renda. Considere que, entre os idosos, a restituição seja concedida em ordem decrescente de idade e que, em subgrupos de pessoas com a mesma idade, a ordem seja decidida por sorteio. Nome Idade (em ano) Orlando 89 Gustavo 86 Luana 86 Teresa 85 Márcia 84 Roberto 82 Heloisa 75 Marisa 75 Pedro 75 João 75 Antônio 72 Fernanda 70 Nessas condições, a probabilidade de João ser a sétima pessoa do grupo a receber sua restituição é igual a  
...
D -  1 × 10−2 
E -  1 × 10−3',0,1),
(2020,  145 ,'Um clube deseja produzir miniaturas em escala do troféu que ganhou no último campeonato. O troféu está representado na Figura 1 e é composto por uma base em formato de um paralelepípedo reto-retângulo de madeira, sobre a qual estão fi xadas três hastes verticais que sustentam uma esfera de 30 cm de diâmetro, que fi ca centralizada sobre a base de madeira. O troféu tem 100 cm de altura, incluída sua base.  A miniatura desse troféu deverá ser instalada no interior de uma caixa de vidro, em formato de paralelepípedo reto-retângulo, cujas dimensões internas de sua base estão indicadas na Figura 2, de modo que a base do troféu seja colada na base da caixa e distante das paredes laterais da caixa de vidro em pelo menos 1 cm. Deve ainda haver uma distância de exatos 2 cm entre o topo da esfera e a tampa dessa caixa de vidro. Nessas condições deseja-se fazer a maior miniatura possível.  A medida da altura, em centímetro, dessa caixa de vidro deverá ser igual a 
...
D -  18. 
E -  20.',0,1),
(2020,  146 ,'Uma casa de dois andares está sendo projetada. É necessário incluir no projeto a construção de uma escada para o acesso ao segundo andar. Para o cálculo das dimensões dos degraus utilizam-se as regras: |2h + b − 63,5| ≤ 1,5 e 16 ≤ h ≤ 19, nas quais h é a altura do degrau (denominada espelho) e b é a profundidade da pisada, como mostra a fi gura. Por conveniência, escolheu-se a altura do degrau como sendo h = 16. As unidades de h e b estão em centímetro. Nesse caso, o mais amplo intervalo numérico ao qual a profundidade da pisada (b) deve pertencer, para que as regras sejam satisfeitas é 
...
D -  31,5 ≤ b ≤ 33 
E -  b ≤ 33',0,1),
(2020,  147 ,'Muitos modelos atuais de veículos possuem computador de bordo. Os computadores informam em uma tela diversas variações de grandezas associadas ao desempenho do carro, dentre elas o consumo médio de combustível. Um veículo, de um determinado modelo, pode vir munido de um dos dois tipos de computadores de bordo: • Tipo A: informa a quantidade X de litro de combustível gasto para percorrer 100 quilômetros; • Tipo B: informa a quantidade de quilômetro que o veículo é capaz de percorrer com um litro de combustível. Um veículo utiliza o computador do Tipo A, e ao fi nal de uma viagem o condutor viu apresentada na tela a informação “X/100”. Caso o seu veículo utilizasse o computador do Tipo B, o valor informado na tela seria obtido pela operação 
...
D -  1/X 
E -  1 ∙ X',0,1),
(2020,  148 ,' A Pesquisa Nacional por Amostra de Domicílios (Pnad) é uma pesquisa feita anualmente pelo IBGE, exceto nos anos em que há Censo. Em um ano, foram entrevistados 363 mil jovens para fazer um levantamento sobre suas atividades profissionais e/ou acadêmicas. Os resultados da pesquisa estão indicados no gráfico. 21,6 13,6 45,2 19,6 Jovens em atividade entre 15 e 29 anos (%) Somente estuda Trabalha e estuda Somente trabalha Não trabalha nem estuda Disponível em: http://noticias.uol.com.br. Acesso em: 20 ago. 2014. De acordo com as informações dadas, o número de jovens entrevistados que trabalha é 
...
D -  284 592. 
E -  291 582.',0,1),
(2020,  149 ,' A Lei de Zipf, batizada com o nome do linguista americano George Zipf, é uma lei empírica que relaciona a frequência ( f ) de uma palavra em um dado texto com o seu ranking (r). Ela é dada por f = A r B . O ranking da palavra é a sua posição ao ordenar as palavras por ordem de frequência. Ou seja, r = 1 para a palavra mais frequente, r = 2 para a segunda palavra mais frequente e assim sucessivamente. A e B são constantes positivas. Diponível em: http://klein.sbm.org.br. Acesso em: 12 ago. 2020 (adatpado). Com base nos valores de X = log (r) e Y = log ( f ) , é possível estimar valores para A e B. No caso hipotético em que a lei é verificada exatamente, a relação entre Y e X é 
...
D -   
E - ',0,1),
(2020,  150 ,'Enquanto um ser está vivo, a quantidade de carbono 14 nele existente não se altera. Quando ele morre, essa quantidade vai diminuindo. Sabe-se que a meia-vida do carbono 14 é de 5 730 anos, ou seja, num fóssil de um organismo que morreu há 5 730 anos haverá metade do carbono 14 que existia quando ele estava vivo. Assim, cientistas e arqueólogos usam a seguinte fórmula para saber a idade de um fóssil encontrado: Q t = Q0 ∙ 2 − t 5730 em que t é o tempo, medido em ano, Q t é a quantidade de carbono 14 medida no instante t e Q0  é a quantidade de carbono 14 no ser vivo correspondente. Um grupo de arqueólogos, numa de suas expedições, encontrou 5 fósseis de espécies conhecidas e mediram a quantidade de carbono 14 neles existente. Na tabela temos esses valores juntamente com a quantidade de carbono 14 nas referidas espécies vivas. Fóssil Q0 Q(t) 1 128 32 2 256 8 3 512 64 4 1 024 512 5 2 048 128 O fóssil mais antigo encontrado nessa expedição foi 
...
D -  4. 
E -  5.',0,1),
(2020,  151 ,'Uma das Sete Maravilhas do Mundo Moderno é o Templo de Kukulkán, localizado na cidade de Chichén Itzá, no México. Geometricamente, esse templo pode ser representado por um tronco reto de pirâmide de base quadrada. As quantidades de cada tipo de figura plana que formam esse tronco de pirâmide são 
...
E -  2 retângulos, 2 quadrados e 2 trapézios retângulos.',0,1),
(2020,  152 ,'Um processo de aeração, que consiste na introdução de ar num líquido, acontece do seguinte modo: uma bomba B retira o líquido de um tanque T1 e o faz passar pelo aerador A1, que aumenta o volume do líquido em 15%, e em seguida pelo aerador A2, ganhando novo aumento de volume de 10%. Ao final, ele fica armazenado num tanque T2, de acordo com a figura. T1 B T2 A1 A2 Os tanques T1 e T2 são prismas retos de bases retangulares, sendo que a base de T1 tem comprimento c e largura L, e a base de T2 tem comprimento c 2  e largura 2L. Para finalizar o processo de aeração sem derramamento do líquido em T2, o responsável deve saber a relação entre a altura da coluna de líquido que já saiu de T1, denotada por X, e a altura da coluna de líquido que chegou a T2, denotada por y. Disponível em: www.dec.ufcg.edu.br. Acesso em: 21 abr. 2015.  A equação que relaciona as medidas das alturas y e x é dada por 
...
D -  y = 1,125x 
E -  y = x',0,1),
(2020,  153 ,'Para chegar à universidade, um estudante utiliza um metrô e, depois, tem duas opções: • seguir num ônibus, percorrendo 2,0 km; • alugar uma bicicleta, ao lado da estação do metrô, seguindo 3,0 km pela ciclovia. O quadro fornece as velocidades médias do ônibus e da bicicleta, em km/h, no trajeto metrô−universidade.  A fim de poupar tempo no deslocamento para a universidade, em quais dias o aluno deve seguir pela ciclovia? 
...
E -  Às terças e quartas-feiras e aos sábados.',0,1),
(2020,  154 ,'Pesquisadores da Universidade de Tecnologia de Viena, na Áustria, produziram miniaturas de objetos em impressoras 3D de alta precisão. Ao serem ativadas, tais impressoras lançam feixes de laser sobre um tipo de resina, esculpindo o objeto desejado. O produto final da impressão é uma escultura microscópica de três dimensões, como visto na imagem ampliada.  A escultura apresentada é uma miniatura de um carro de Fórmula 1, com 100 micrômetros de comprimento. Um micrômetro é a milionésima parte de um metro. Usando notação científica, qual é a representação do comprimento dessa miniatura, em metro? 
...
D -  1,0 × 10 − 6 
E -  1,0 × 10 − 7',0,1),
(2020,  155 ,'O artista gráfico holandês Maurits Cornelius Escher criou belíssimas obras nas quais as imagens se repetiam, com diferentes tamanhos, induzindo ao raciocínio de repetição infinita das imagens. Inspirado por ele, um artista fez um rascunho de uma obra na qual propunha a ideia de construção de uma sequência de infinitos quadrados, cada vez menores, uns sob os outros, conforme indicado na figura. O quadrado PRST, com lado de medida 1, é o ponto de partida. O segundo quadrado é construído sob ele tomando-se o ponto médio da base do quadrado anterior e criando-se um novo quadrado, cujo lado corresponde à metade dessa base. Essa sequência de construção se repete recursivamente. Qual é a medida do lado do centésimo quadrado construído de acordo com esse padrão? 
...
D -  9!/2 
E -  4! 5!/2',0,1),
(2020,  164 ,'A exposição a barulhos excessivos, como os que percebemos em geral em trânsitos intensos, casas noturnas e espetáculos musicais, podem provocar insônia, estresse, infarto, perda de audição, entre outras enfermidades. De acordo com a Organização Mundial da Saúde, todo e qualquer som que ultrapasse os 55 decibéis (unidade de intensidade do som) já pode ser considerado nocivo para a saúde. O gráfico foi elaborado a partir da medição do ruído produzido, durante um dia, em um canteiro de obras. Disponível em: www.revistaencontro.com.br. Acesso em: 12 ago. 2020 (adaptado). Nesse dia, durante quantas horas o ruído esteve acima de 55 decibéis? 
...
D -  11 
E -  13',0,1),
(2020,  165 ,'O técnico de um time de basquete pretende aumentar a estatura média de sua equipe de 1,93 m para, no mínimo, 1,99 m. Para tanto, dentre os 15 jogadores que fazem parte de sua equipe, irá substituir os quatro mais baixos, de estaturas: 1,78 m, 1,82 m, 1,84 m e 1,86 m. Para isso, o técnico contratou um novo jogador de 2,02 m. Os outros três jogadores que ele ainda precisa contratar devem satisfazer à sua necessidade de aumentar a média das estaturas da equipe. Ele fi xará a média das estaturas para os três jogadores que ainda precisa contratar dentro do critério inicialmente estabelecido. Qual deverá ser a média mínima das estaturas, em metro, que ele deverá fi xar para o grupo de três novos jogadores que ainda irá contratar? 
...
D -  2,06 
E -  2,08',0,1),
(2020,  166 ,'O consumo de espumantes no Brasil tem aumentado nos últimos anos. Uma das etapas do seu processo de produção consiste no envasamento da bebida em garrafas semelhantes às da imagem. Nesse processo, a vazão do líquido no interior da garrafa é constante e cessa quando atinge o nível de envasamento. Nível de envasamento da garrafa Qual esboço de gráfi co melhor representa a variação da altura do líquido em função do tempo, na garrafa indicada na imagem? 
...
D -   
E - ',0,1),
(2020,  167 ,'O quadro representa os gastos mensais, em real, de uma família com internet, mensalidade escolar e mesada do fi lho. Internet Mensalidade escolar Mesada do fi lho 120 700 400 No início do ano, a internet e a mensalidade escolar tiveram acréscimos, respectivamente, de 20% e 10%. Necessitando manter o valor da despesa mensal total com os itens citados, a família reduzirá a mesada do fi lho. Qual será a porcentagem da redução da mesada? 
...
D -  30. 
E -  34.',0,1),
(2020,  169 ,'Um grupo sanguíneo, ou tipo sanguíneo, baseia-se na presença ou ausência de dois antígenos, A e B, na superfície das células vermelhas do sangue. Como dois antígenos estão envolvidos, os quatro tipos sanguíneos distintos são: • Tipo A: apenas o antígeno A está presente; • Tipo B: apenas o antígeno B está presente; • Tipo AB: ambos os antígenos estão presentes; • Tipo O: nenhum dos antígenos está presente. Disponível em: http://saude.hsw.uol.com.br. Acesso em: 15 abr. 2012 (adaptado). Foram coletadas amostras de sangue de 200 pessoas e, após análise laboratorial, foi identificado que em 100 amostras está presente o antígeno A, em 110 amostras há presença do antígeno B e em 20 amostras nenhum dos antígenos está presente. Dessas pessoas que foram submetidas à coleta de sangue, o número das que possuem o tipo sanguíneo A é igual a 
...
D -  5,83. 
E -  6,26.',0,1),
(2020,  173 ,'Pergolado é o nome que se dá a um tipo de cobertura projetada por arquitetos, comumente em praças e jardins, para criar um ambiente para pessoas ou plantas, no qual há uma quebra da quantidade de luz, dependendo da posição do sol. É feito como um estrado de vigas iguais, postas paralelas e perfeitamente em fi la, como ilustra a fi gura. 30 cm 30 cm Um arquiteto projeta um pergolado com vãos de 30 cm de distância entre suas vigas, de modo que, no solstício de verão, a trajetória do sol durante o dia seja realizada num plano perpendicular à direção das vigas, e que o sol da tarde, no momento em que seus raios fi zerem 30° com a posição a pino, gere a metade da luz que passa no pergolado ao meio-dia. Para atender à proposta do projeto elaborado pelo arquiteto, as vigas do pergolado devem ser construídas de maneira que a altura, em centímetro, seja a mais próxima possível de 
...
D -  52. 
E -  60.',0,1),
(2020,  174 ,'O fenômeno das manifestações populares de massa traz à discussão como estimar o número de pessoas presentes nesse tipo de evento. Uma metodologia usada é: no momento do ápice do evento, é feita uma foto aérea da via pública principal na área ocupada, bem como das vias afl uentes que apresentem aglomerações de pessoas que acessam a via principal. A foto é sobreposta por um mapa virtual das vias, ambos na mesma escala, fazendo-se um esboço geométrico da situação. Em seguida, subdivide-se o espaço total em trechos, quantifi cando a densidade, da seguinte forma: • 4 pessoas por metro quadrado, se elas estiverem andando em uma mesma direção; • 5 pessoas por metro quadrado, se elas estiverem se movimentando sem deixar o local; • 6 pessoas por metro quadrado, se elas estiverem paradas. É feito, então, o cálculo do total de pessoas, considerando os diversos trechos, e desconta-se daí 1 000 pessoas para cada carro de som fotografado. Com essa metodologia, procederam-se aos cálculos para estimar o número de participantes na manifestação cujo esboço geométrico é dado na fi gura. Há três trechos na via principal: MN, NO e OP, e um trecho numa via afl uente da principal: QR . Legenda: 30 m 100 m 100 m 300 m 200 m Via principal M N R O P Q 30 m Andando em uma mesma direção ou Movimentando sem deixar o local Parado Carro de som Obs.: a figura não está em escala (considere as medidas dadas). Segundo a metodologia descrita, o número estimado de pessoas presentes a essa manifestação foi igual a 
...
D -  92 000. 
E -  87 000.',0,1),
(2020,  175 ,'Um administrador resolve estudar o lucro de sua empresa e, para isso, traça o gráfico da receita e do custo de produção de seus itens, em real, em função da quantidade de itens produzidos. O lucro é determinado pela diferença: Receita – Custo. O gráfico que representa o lucro dessa empresa, em função da quantidade de itens produzidos, é 
...
D -   
E -  ',0,1),
(2020,  177 ,'A Figura 1 apresenta uma casa e a planta do seu telhado, em que as setas indicam o sentido do escoamento da água de chuva. Um pedreiro precisa fazer a planta do escoamento da água de chuva de um telhado que tem três caídas de água, como apresentado na Figura 2. (a) Casa (b) Planta do telhado Figura 1 Figura 2  A figura que representa a planta do telhado da Figura 2 com o escoamento da água de chuva que o pedreiro precisa fazer é 
...
D -  
E -  ',0,1),
(2020,  178 ,'Suponha que uma equipe de corrida de automóveis disponha de cinco tipos de pneu (I, II, III, IV, V), em que o fator de eficiência climática EC (índice que fornece o comportamento do pneu em uso, dependendo do clima) é apresentado: • EC do pneu I: com chuva 6, sem chuva 3; • EC do pneu II: com chuva 7, sem chuva −4; • EC do pneu III: com chuva −2, sem chuva 10; • EC do pneu IV: com chuva 2, sem chuva 8; • EC do pneu V: com chuva −6, sem chuva 7. O coeficiente de rendimento climático (CRC) de um pneu é calculado como a soma dos produtos dos fatores de EC, com ou sem chuva, pelas correspondentes probabilidades de se ter tais condições climáticas: ele é utilizado para determinar qual pneu deve ser selecionado para uma dada corrida, escolhendo-se o pneu que apresentar o maior CRC naquele dia. No dia de certa corrida, a probabilidade de chover era de 70% e o chefe da equipe calculou o CRC de cada um dos cinco tipos de pneu. O pneu escolhido foi 
...
D -  IV. 
E -  V.',0,1),
(2020,  179 ,'Um pé de eucalipto em idade adequada para o corte rende, em média, 20 mil folhas de papel A4. A densidade superficial do papel A4, medida pela razão da massa de uma folha desse papel por sua área, é de 75 gramas por metro quadrado, e a área de uma folha de A4 é 0,062 metro quadrado. Disponível em: http://revistagalileu.globo.com. Acesso em: 28 fev. 2013 (adaptado). Nessas condições, quantos quilogramas de papel rende, em média, um pé de eucalipto? 
...
D -  267 
E -  93',0,1),
(2020,  180 ,'Com o objetivo de contratar uma empresa responsável pelo serviço de atendimento ao público, os executivos de uma agência bancária realizaram uma pesquisa de satisfação envolvendo cinco empresas especializadas nesse segmento. Os procedimentos analisados (com pesos que medem sua importância para a agência) e as respectivas notas que cada empresa recebeu estão organizados no quadro.  A agência bancária contratará a empresa com a maior média ponderada das notas obtidas nos procedimentos analisados. Após a análise dos resultados da pesquisa de satisfação, os executivos da agência bancária contrataram a empresa 
