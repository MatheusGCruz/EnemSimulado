/*
UPDATE [dbo].[stage_dto] SET message = 'Digite a cor do caderno, o ano da prova, e o numero da questão (separados por virgulas):' where stage = 402
--*/
...
-- (0, 0, 'Registro de novos usuários', 1, 'Mensagem-Registro', 0, 0, 1, NULL, '/register'),
-- (0, 0, 'Inativação de usuario', 1, 'Mensagem - Inativação', 0, 0, 2, NULL, '/exit'),
-- (0, 0, 'Lista as matrizes de conhecimento', 0, 'Mensagem-Matrizes', 0, 0, 3, NULL, '/matrizes'),
-- (0, 0, 'Pesquisa questoes do Enem', 1, 'Escolha uma opção: /texto para pesquisar pelo texto da questao, /ano para pesquisar uma questao especifica', 0, 0, 4, NULL, '/pesquisa'),
...
-- (1, 901, 'Insere nova questão', 1, 'Digite o ano, questão e matriz:', 0, 0, 90, NULL, '/new'),
...
-- (1, 910, 'Insere nova questão com imagem', 1, 'Digite o ano, questão e matriz:', 0, 0, 91, NULL, '/newImage'),
